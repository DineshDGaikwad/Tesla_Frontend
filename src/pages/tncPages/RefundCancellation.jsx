...
const RefundCancellation = () => {
    ...
    <NavBar/>
      <div className="p-6">
      <h2 className="text-2xl font-bold">refund and cancellation</h2>
      ...
      Tesla Academy does not accept cancellation requests for perishable items like flowers, eatables,
      ...
      In case of any refunds approved by Tesla Academy, it will take 7 days for the refund to be
      processed to you.</div>
      </>
    );
};
