  ...
  return (
      ...
      <NavBar/>
        ...
        <h2 className="text-2xl font-bold">Terms and Conditions</h2>
          ...
          for access or usage of domain name tesla-academy.in ('Website'),
          including the related mobile site and mobile application (hereinafter
          referred to as 'Platform'). The Platform is owned by Tesla Academy, a
          company incorporated under the Companies Act, 1956 with its registered
          office at F 103, Hubtown Countrywoods, Katraj Kondhwa rd, Tilekar
          nagar, Pune 411048 ,Pune ,India (hereinafter referred to as ‘Platform
          ...
          these Terms of Use to stay informed of updates.. For the purpose of
          these Terms of Use, wherever the context so requires ‘you’, 'your' or
          ‘user’ shall mean any natural or legal person who has agreed to become
          a user/buyer on the Platform.. ACCESSING, BROWSING OR OTHERWISE USING
          ...
          BEFORE PROCEEDING.. The use of Platform and/or availing of our
          Services is subject to the following Terms of Use: To access and use
          the Services, you agree to provide true, accurate and complete
          ...
          use of our Services and the Platform is solely and entirely at your
          ...
          Services meet your requirements.. The contents of the Platform and the
          Services are proprietary to us and are licensed to us. You will not
          have any authority to claim any intellectual property rights, title,
          or interest in its contents. The contents includes and is not limited
          ...
          the Services.. 10. 11. 12. 13. 14. You shall indemnify and hold
          harmless Platform Owner, its affiliates, group companies (as
          ...
          jurisdiction of the courts in Pune and Maharashtra. All concerns or
